...
async function executeBurnAndBridge(
  ...
  // size lean. The instruction discriminator is keccak256("global:burn_and_bridge")[0..8].
  // Generated by: anchor build (written to target/idl) — hardcoded here for dev.
  //
  // Discriminator for `burn_and_bridge` (Anchor global namespace):
  const discriminator = Buffer.from([
    0x0f, 0xb9, 0xba, 0x5a, 0x74, 0x2e, 0x47, 0x26, // sha256("global:burn_and_bridge")[0..8]
  ]);
